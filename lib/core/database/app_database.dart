...
export 'package:warehouse_app/features/additional.data/stock_bag/data/tables/stock_bag_table.dart';
  ...
  MigrationStrategy get migration {
    return MigrationStrategy(
      ...
      onUpgrade: (m, from, to) async {
        ...
        // v13 -> v14: local stock-bag cache for offline-first warehouse
        // operations. The app can select bags without a live stock-bags API.
        if (from < 14) {
          await customStatement(createCachedStockBagsSql);
          await customStatement(createCachedStockBagsLookupIndexSql);
          await customStatement(createCachedStockBagsTagIndexSql);
