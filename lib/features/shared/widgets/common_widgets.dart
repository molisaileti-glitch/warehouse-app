...
class PendingSyncFloatingBanner extends StatelessWidget {
  final int count;
  final VoidCallback onTap;
  final Color color;

  const PendingSyncFloatingBanner({
    super.key,
    required this.count,
    required this.onTap,
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.cloud_upload_outlined, color: color, size: 20),
